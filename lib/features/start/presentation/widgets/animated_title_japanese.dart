...
class TitleJapanese extends StatelessWidget {
  const TitleJapanese({super.key, required this.height, required this.startDelay});
  ...
  Duration get firstSignDelay => startDelay;

  Duration get secondSignDelay => startDelay + 100.ms;
